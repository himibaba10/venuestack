...
function venuestack_render_register_form(): void {
	...
	<div class="venuestack-auth-form venuestack-auth-form--register">
		...
		<?php else : ?>
			...
			<form method="post" action="<?php echo esc_url( venuestack_get_auth_page_url( 'register' ) ); ?>" class="venuestack-auth-form__fields">
				...
				<div class="venuestack-auth-form__row">
					<label class="venuestack-auth-form__field">
						<span class="is-style-label"><?php echo esc_html__( 'First name', 'venuestack' ); ?></span>
						<input type="text" name="first_name" autocomplete="given-name" class="venuestack-auth-form__input" />
					</label>
					<label class="venuestack-auth-form__field">
						<span class="is-style-label"><?php echo esc_html__( 'Last name', 'venuestack' ); ?></span>
						<input type="text" name="last_name" autocomplete="family-name" class="venuestack-auth-form__input" />
					</label>
				</div>

				<label class="venuestack-auth-form__field">
					<span class="is-style-label"><?php echo esc_html__( 'Username', 'venuestack' ); ?></span>
					<input type="text" name="user_login" required autocomplete="username" class="venuestack-auth-form__input" />
				</label>

				<label class="venuestack-auth-form__field">
					<span class="is-style-label"><?php echo esc_html__( 'Email', 'venuestack' ); ?></span>
					<input type="email" name="user_email" required autocomplete="email" class="venuestack-auth-form__input" />
				</label>

				<label class="venuestack-auth-form__field">
					<span class="is-style-label"><?php echo esc_html__( 'Password', 'venuestack' ); ?></span>
					<input type="password" name="user_pass" required autocomplete="new-password" minlength="8" class="venuestack-auth-form__input" />
				</label>

				<label class="venuestack-auth-form__field">
					<span class="is-style-label"><?php echo esc_html__( 'Confirm password', 'venuestack' ); ?></span>
					<input type="password" name="user_pass_confirm" required autocomplete="new-password" minlength="8" class="venuestack-auth-form__input" />
				</label>
			...
			<p class="venuestack-auth-form__links is-style-body">
				<a href="<?php echo esc_url( $login_url ); ?>"><?php echo esc_html__( 'Already have an account? Log in', 'venuestack' ); ?></a>
			</p>
		<?php endif; ?>
	</div>
	<?php
