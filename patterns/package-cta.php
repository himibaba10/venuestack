...
/**
 * Title: Package CTA
 * Slug: venuestack/package-cta
 * Categories: venuestack, call-to-action
 * Description: Full-bleed booking call-to-action band for a single event package.
 * Viewport Width: 1200
 *
 * @package Venuestack
 */
...
<h2 class="wp-block-heading has-text-align-center is-style-section has-plaster-color has-text-color"><?php echo esc_html__( 'Ready to add this to a booking?', 'venuestack' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"is-style-lede","style":{"typography":{"textAlign":"center"}},"textColor":"plaster-muted"} -->
<p class="has-text-align-center is-style-lede has-plaster-muted-color has-text-color"><?php echo esc_html__( 'Pick a room, hold your date, and choose this package in checkout.', 'venuestack' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-plaster-color has-brass-background-color has-text-color has-background wp-element-button" href="/spaces/" style="border-radius:0px"><?php echo esc_html__( 'Browse spaces', 'venuestack' ); ?></a></div>
<!-- /wp:button -->
