 ...
 * Description: Live inventory stats strip for the homepage. Values are bound and locked.
 * Viewport Width: 1200
 * Inserter: no
 *
 * @package Venuestack
...
$types_label  = esc_html( venuestack_get_home_stat_display( 'space_types' ) );
?>
